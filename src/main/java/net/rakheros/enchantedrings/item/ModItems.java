...
import net.rakheros.enchantedrings.item.custom.InfusedGemItem;

public class ModItems {
    public static final Item BASE_RING = registerItem("base_ring", new Item(new Item.Settings()));
    public static final Item ENCHANTED_RING = registerItem("enchanted_ring", new EnchantedRingItem(new Item.Settings().maxCount(1)));
